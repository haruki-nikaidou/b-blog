...
This structural constraint explains why Type II predominantly appears in *isekai* (異世界, alternative world) works. These settings inherently provide the necessary external threats, like hostile environments, existential conflicts, survival imperatives, without requiring authors to justify their presence within contemporary social frameworks. Notably, authors who employ Type II often do so without foregrounding romance as their primary narrative objective; the alliance-to-romance progression emerges naturally from the genre's built-in adversarial structure rather than from deliberate romantic plotting.